...
const RiskAssessmentDetail = () => {
    ...
    return (
        <div className="mx-auto w-full max-w-2xl p-6">
            <div className="mb-6">
                <h1 className="text-lg font-semibold text-slate-800">Patient Risk Assessment Detail</h1>
                <p className="mt-1 text-sm text-slate-500">View and manage assessment results.</p>
            </div>
                    ...
                    <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                        ...
                        <div>
                            <div className={INFO_ROW}>
                                <span className="text-slate-500">Risk Assessment ID</span>
                            ...
                            <div className={INFO_ROW}>
                                <span className="text-slate-500">Assessment Date/Time</span>
