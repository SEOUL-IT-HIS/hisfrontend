...
function* fetchRoomsSaga(action: PayloadAction<PageParams | undefined>) {
  try {
    ...
    yield put(
      fetchRoomsFailure(
        getSurgeryErrorMessage(err, "Failed to load operating rooms."),
      ),
    );
  }
}
  ...
  try {
    ...
    const message =
      err instanceof Error
        ? err.message
        : "Failed to load available operating rooms.";
...
function* fetchRoomSaga(action: PayloadAction<string>) {
  try {
    ...
    yield put(
      fetchRoomFailure(
        getSurgeryErrorMessage(err, "Failed to load the operating room."),
      ),
    );
  }
}
...
function* createRoomSaga(action: PayloadAction<CreateRoomRequest>) {
  try {
    ...
    yield put(
      roomMutationFailure(
        getSurgeryErrorMessage(err, "Failed to create the operating room."),
      ),
    );
  }
}
...
function* updateRoomSaga(
  ...
  try {
    ...
    yield put(
      roomMutationFailure(
        getSurgeryErrorMessage(err, "Failed to update the operating room."),
      ),
    );
  }
}
...
function* changeRoomStatusSaga(
  ...
  try {
    ...
    yield put(
      roomMutationFailure(
        getSurgeryErrorMessage(err, "Failed to change the operating room status."),
      ),
    );
  }
}
...
function* changeRoomTurnoverSaga(
  ...
  try {
    ...
    yield put(
      roomMutationFailure(
        getSurgeryErrorMessage(err, "Failed to change the turnover status."),
      ),
    );
  }
}
...
function* fetchEquipmentsSaga(action: PayloadAction<PageParams | undefined>) {
  try {
    ...
    yield put(
      fetchEquipmentsFailure(
        getSurgeryErrorMessage(err, "Failed to load equipment."),
      ),
    );
  }
}
...
function* fetchEquipmentSaga(action: PayloadAction<string>) {
  try {
    ...
    yield put(
      fetchEquipmentFailure(
        getSurgeryErrorMessage(err, "Failed to load the equipment."),
      ),
    );
  }
}
...
function* createEquipmentSaga(action: PayloadAction<CreateEquipmentRequest>) {
  try {
    ...
    yield put(
      equipmentMutationFailure(
        getSurgeryErrorMessage(err, "Failed to create the equipment."),
      ),
    );
  }
}
...
function* updateEquipmentSaga(
  ...
  try {
    ...
    yield put(
      equipmentMutationFailure(
        getSurgeryErrorMessage(err, "Failed to update the equipment."),
      ),
    );
  }
}
...
function* changeEquipmentStatusSaga(
  ...
  try {
    ...
    yield put(
      equipmentMutationFailure(
        getSurgeryErrorMessage(err, "Failed to change the equipment status."),
      ),
    );
  }
}
...
function* changeEquipmentInoutSaga(
  ...
  try {
    ...
    yield put(
      equipmentMutationFailure(
        getSurgeryErrorMessage(err, "Failed to process the check-out / check-in."),
      ),
    );
  }
}
