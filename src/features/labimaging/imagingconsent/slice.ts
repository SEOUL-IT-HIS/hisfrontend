...
/**
 * imagingconsent(조영제/침습검사 동의) slice
...
const consentSlice = createSlice({
  name: "labImaging/imagingconsent",
  initialState,
  reducers: {
    // ---------- 오더의 동의 이력 조회 ----------
...
type ConsentRoot = { labImaging: { imagingconsent: ConsentState } };

export const selectConsents = (s: ConsentRoot) =>
  s.labImaging.imagingconsent.consents;
export const selectConsentsLoading = (s: ConsentRoot) =>
  s.labImaging.imagingconsent.consentsLoading;
export const selectConsentsError = (s: ConsentRoot) =>
  s.labImaging.imagingconsent.consentsError;
export const selectLoadedConsentOrderId = (s: ConsentRoot) =>
  s.labImaging.imagingconsent.loadedImageOrderId;

export const selectConsentCreating = (s: ConsentRoot) =>
  s.labImaging.imagingconsent.creating;
