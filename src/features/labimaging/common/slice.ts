...
import imagingacquisitionReducer from "@/features/labimaging/imagingacquisition/slice";
 ...
 *   반드시 그대로 맞춘다. (labspecimen/slice.ts, imagingacquisition/slice.ts selector 참고)
 *
 * TODO: labschedule / imagingschedule slice 작성 후 아래에 함께 등록한다.
 */
const labImagingReducer = combineReducers({
  labspecimen: labspecimenReducer,
  imagingacquisition: imagingacquisitionReducer,
});
